...
5. Ground reaction force (GRF) is the force acting on the load. GRF is the *most important force* in the `vjsim`, since it represent the foce usually tracked in the sport science.
6. GRF is acting on the load object, but load also has weight. To get **propulsive force**, we need to deduct **weight** from the GRF
7. Once we have propulsive or net force, to calculate acceleration, we need to divide it with load inertia or **mass**
