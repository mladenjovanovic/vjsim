...
- *Force-Time* characteristic has one parameter: **time to max activation**. **Initial force** parameter represents the weight of the moving object (i.e. $(bodyweight + external \; load) \times 9.81$) since the vertical jumps starts from a dead start (and thus will not be considered further as simulation parameter).
